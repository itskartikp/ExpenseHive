...
class App extends Component {
    ...
    render() {
        ...
        */
        ...
        const cards = {
            card8: { backgroundImage: `url('./assets/images/travel.png')`},
            card7: { backgroundImage: `url()` },
            card6: { backgroundImage: `url()` },
            card5: { backgroundImage: `url()` },
            card4: { backgroundImage: `url()` },
            card3: { backgroundImage: `url()` },
            card2: { backgroundImage: `url()` },
            card1: { backgroundImage: `url()` }
        };
